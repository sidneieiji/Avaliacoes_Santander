class Fatmastar < SitePrism::Page
    ...
    element :episodio_1, :css, '#mG61Hd > div > div.freebirdFormviewerViewFormContent > div.freebirdFormviewerViewItemList > div:nth-child(5) > div:nth-child(2) > div:nth-child(2) > div > label > div > div.docssharedWizToggleLabeledContent > div > span'
    element :episodio_3, :css, '#mG61Hd > div > div.freebirdFormviewerViewFormContent > div.freebirdFormviewerViewItemList > div:nth-child(5) > div:nth-child(2) > div:nth-child(4) > div > label > div > div.docssharedWizToggleLabeledContent > div > span'
